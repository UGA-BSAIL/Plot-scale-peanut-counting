...
if __name__ == '__main__':
    postfix = 'jpg'
    img_path = '/blue/lift-phenomics/zhengkun.li/peanut_project/data/peanut_tifton_patch/valid/images'
    label_path = '/blue/lift-phenomics/zhengkun.li/peanut_project/data/peanut_tifton_patch/valid/labels'
    predict_path = '/blue/lift-phenomics/zhengkun.li/update/RTDETR_su/runs/val/val25/labels'
    save_path = '/blue/lift-phenomics/zhengkun.li/peanut_project/data/peanut_tifton_patch/valid/vis_ours_2'
    classes = ['peanut']
    # define color: detect_color, missing_color, error_color are green, red, blue respectively
