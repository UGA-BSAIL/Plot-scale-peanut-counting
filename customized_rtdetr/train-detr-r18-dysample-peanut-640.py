...
if __name__ == '__main__':
    ...
    model = RTDETR("ultralytics/cfg/models/rt-detr/rtdetr-resnet18-DySample.yaml")
    ...
    model.train(data='/blue/lift-phenomics/zhengkun.li/peanut_project/data/peanut_tifton_patch/data.yaml',
                ...
                project='/blue/lift-phenomics/zhengkun.li/peanut_project/training_result/peanut_rtdetr-DySample-r18-640',
                name='peanut_rtdetr-r18-DySample-640-epoch1000',
                )