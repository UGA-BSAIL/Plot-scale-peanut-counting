...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='/blue/lift-phenomics/zhengkun.li/peanut_project/training_result/peanut_rtdetr-resnet18-FasterBlock-ADown-Dysample-r18-640/peanut_rtdetr-resnet18-FasterBlock-ADown-Dysample-epoch1000/weights/best.pt', help='training model path')
    parser.add_argument('--source', type=str, default='/blue/lift-phenomics/zhengkun.li/peanut_project/data/peanut_tifton_patch/valid/images', help='source directory for images or videos')
...
if __name__ == '__main__':
    ...
    model  = RTDETR(weight=opt.weight)
